# This code snippet is adapted from MBRS:
# https://github.com/jzyustc/MBRS
# Original source file: https://github.com/jzyustc/MBRS/blob/main/network/noise_layers/jpeg.py
# Author: jzyustc
...
class Jpeg(JpegBasic):
	...
	def forward(self, image, mask):
		...
		return noised_image.clamp(-1, 1), mask
...
class JpegSS(JpegBasic):
	...
	def forward(self, image_and_cover, mask):
